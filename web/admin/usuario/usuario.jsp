...
<div class="botoes direita">
    <html:link page="/Usuario.do?acao=adicionar" styleClass="novo">
        <span>Novo</span>
    </html:link>
</div>
...
<table width="100%" border="0" cellpadding="2" cellspacing="1"
    ...
    <!-- for -->
    <tbody>
        <c:forEach var="usuario" items="${UsuarioForm.usuarios}" varStatus="id">
            <tr>
                <td>${usuario.nome}</td>
                <td>${usuario.grupo}</td>
                <td align="center">
                    <html:link page="/Usuario.do?acao=editar&codUsuario=${usuario.id}">
                        <span>Editar</span>
                    </html:link>
                </td>
                <td align="center">
                    <html:link page="/Usuario.do?acao=remover&codUsuario=${usuario.id}" styleClass="remover">
                        <span>Remover</span>
                    </html:link>
                </td>
